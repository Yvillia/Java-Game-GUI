...
public class Settings {
    ...
    // 9. STYLE
        ...
        //THEME
            ...
            private static final File STANDARDCSS = new File("STANDARDCSS.preset");
            private static final File DARKTHEMECSS = new File("DARKTHEMECSS.preset");
            private static final File WARMCSS = new File("WARMCSS.preset");
            private static final File OCEANCSS = new File("OCEANCSS.preset");
            public static File CSS = new File("SettingsCSS.css");
            
            //File Load-ins for Terms and About
            private static final File ABOUTFILE = new File("About Section.carrot");
            private static final File TERMSFILE = new File("Terms and Agreements.carrot");
    ...
    private void presetChanger(int itemIndex)
    {
        ...
        switch(itemIndex)
        {
             ...
             case 0:
                 try{
                     THEMEPRINTER = new PrintWriter(new FileOutputStream(CSS), false);
             ...
             case 3:
                 try{
                     ...
                     FileInputStream inputStream = new FileInputStream("file:///" + OCEANCSS.getAbsolutePath().replace("\\", "/"));
                     BufferedInputStream systemFile = new BufferedInputStream(inputStream);
