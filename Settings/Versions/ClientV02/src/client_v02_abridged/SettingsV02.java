...
public class SettingsV02 {
    ...
    //STYLINGS
        ...
        //THEME
            ...
            private static String buttonString = "-fx-padding: 10 10 10 10; "
                                + "-fx-vertical-align: middle; "
                                + "-fx-position: absolute;";
                     
            private static String rootString = "";
            
            private static String buttonHoverString = "-fx-padding: 10 10 10 10; "
                                     + "-fx-letter-spacing: 2; "
                                     + "-fx-vertical-align: middle; "
                                     + "-fx-position: absolute;";
                     
            private static String backButtonString = ".BackButton"
                                    + "{\n "
                                    + "-fx-padding: 10 10 10 10; "
                                    + "-fx-position: absolute; "
                                    + "-fx-vertical-align: middle;";
                     
            private static String backHoverString = ".BackButton:hover"
                                   + "{\n "
                                   + "-fx-padding: 10 10 10 10; "
                                   + "-fx-letter-spacing: 2; "
                                   + "-fx-vertical-align: middle; "
            ...
            private static String[][] tempStyleSetup = new String[3][]; 
            
            //File Load-ins for Theme Presets
            private static final File STANDARD = new File("TextDocx\\STANDARD.preset");
            private static final File DARKTHEME = new File("TextDocx\\DARKTHEME.preset");
            private static final File WARM = new File("TextDocx\\WARM.preset");
            private static final File OCEAN = new File("TextDocx\\OCEAN.preset");
            private static File CSS = new File("Client_V02_Abridged\\src\\Settings.css");
    ...
    SettingsV02(Stage CURRENTSTAGE){
    ...
    {   
        ...
        {    
            //Adds the the Final Theme Changes to the Strings that will be Printed to the CSS File
            buttonString += styleSetup[0][0] + "\n" + styleSetup[0][1] + "\n";
            buttonHoverString += styleSetup[1][0] + "\n";
            rootString += styleSetup[2][0] + styleSetup[2][1] + styleSetup[2][2] + styleSetup[2][3];
    ...
    private void changeSetup()
    {
            ...
            try{
                ...
                //For-Loop to Read Through the tempStyleSetup Array
                for(int index = 0; index < tempStyleSetup.length; index++)
                {
                    completeString += tempStyleSetup[index] + "}\n";
                }
            ...
            {       
                case 1:
                    switch(itemIndex)
                    {
                        ...
                        case 1:
                            styleSetup[0][1] = "-fx-text-color: #" + color.getValue().toString().substring(2, 8) + ";";
                            break;
